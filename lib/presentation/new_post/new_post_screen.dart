...
class NewPostCreate extends StatelessWidget {
  const NewPostCreate({super.key});
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            SizedBox(width: 20,),
            CircleAvatar( radius: 15,backgroundColor: ColorConstants.ff9228Color,child: Icon(Icons.arrow_right_alt ,color: Colors.white)),
          ],
        ),
      ),
